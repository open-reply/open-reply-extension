  ...
  return (
    <>
      <div className='flex flex-row justify-between align-middle items-center'>
        ...
        <Switch
          className='scale-75'
          checked={moderation.checkOwnCommentForOffensiveSpeech}
          onCheckedChange={checkOwnCommentForOffensiveSpeech =>
            setCheckOwnCommentForOffensiveSpeech(checkOwnCommentForOffensiveSpeech)
          }
