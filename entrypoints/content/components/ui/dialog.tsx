  ...
  React.useEffect(() => {
    ...
    if (shadowHost && shadowHost.shadowRoot && applicationContainer) {
      ...
      if (!containerRef.current) {
        ...
        containerRef.current.id = `dialog-container-${idRef.current}`
      }
      
      // Append the container to the shadow root if it's not already there
      if (!shadowHost.shadowRoot.getElementById(`dialog-container-${idRef.current}`)) {
...
const DialogPortal: React.FC<DialogPrimitive.DialogPortalProps> = (props) => {
  ...
  return <DialogPrimitive.Portal {...props} container={shadowRootElement} />
}
